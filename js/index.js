...
window.onload = function() {
    let workLine = localStorage.getItem('axionis');
    ...
    if (workLine) {
        ...
        // If no axionis exists in localStorage, show the welcome screen
...
function savename() {
            ...
            // Save the JSON object in localStorage as 'axionis'
            localStorage.setItem('axionis', JSON.stringify(data));

            // Hide the welcome container
            document.getElementById('welcome').style.display = 'none';

            // Show the user's name in the specified element
            document.getElementById('name').innerHTML = `<i class="fa-solid fa-chevron-right"></i> ${inputedName}`;
